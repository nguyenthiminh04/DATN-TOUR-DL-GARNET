...
class CategoryTourController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.category_tour.index', compact('listCategoryTour'));
    }
    ...
    public function create()
    {
        ...
        $listStatus = Status::query()->get();
        $listTour = Tour::all();
        return view('admin.category_tour.add', compact('listTour'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'category_tour' => 'required|max:180',
        ...
        $categoryTour->category_tour = $request->input('category_tour');
        ...
        return redirect()->route('category_tour.index')->with('success', 'Thêm danh mục Tour thành công!');
    }
    ...
    return view('admin.category_tour.edit', compact('categoryTour', 'listTour'));
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('category_tour.index')->with('success', 'Cập nhật danh mục Tour thành công!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        // Chuyển hướng về trang danh sách với thông báo thành công
        return redirect()->route('category_tour.index')->with('success', 'Xóa danh mục Tour thành công!');
    }
