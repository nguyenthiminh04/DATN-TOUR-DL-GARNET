                            ...
                            <div class="kiri p-3">
                                <div class="icon-container ">
                                    <div class="icon-container_box">
                                        <img src="https://magiamgia.com/wp-content/uploads/2020/12/fnal-logo.png" width="85" alt="totoprayogo.com" class="" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="kanan">
                                <div class="info m-3 d-flex align-items-center">
                                    <div class="w-100">
                                        ...
                                        <button class="btn " onclick="copyToClipboard('{{ $coupon->code }}')">Copy</button>
                                    </div>
                                </div>
                            </div>
                        </div>
