...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('/comment/toggle-status/{id}',  [CommentController::class, 'toggleStatus'])->name('comment.toggleStatus');
    Route::get('comment',                       [CommentController::class,'index'])->name('comment');
    Route::delete('comment/{id}/destroy',       [CommentController::class, 'destroy'])->name('comment.force-delete');
