                                                            ...
                                                            <div class="tour-horizontal-layout">
                                                                ...
                                                                <div class="tour-details">
                                                                    ...
                                                                    <div class="highlight-info">
                                                                        <p><strong>Ngày khởi hành: </strong> <span id="selected-date">{{ \Carbon\Carbon::parse($booking->start_date)->format('d/m/Y') }}</span></p>
                                                                    ...
                                                                    <p><strong>Trạng thái đơn hàng:</strong> <span>{{ $payment->status->name }}</span></p>
                <p><strong>Ngày đặt:</strong> <span>{{ \Carbon\Carbon::parse($payment->time)->format('d/m/Y') }}</span></p>
                <p><strong>Số tiền thanh toán:</strong> <span>{{ number_format($payment->money, 0, ',', '.') }} VND</span>
                    <p><strong>Trạng thái thanh toán:</strong> <span>{{ $payment->paymentStatus->name }}</span></p>
