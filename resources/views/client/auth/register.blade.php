        ...
        <div class="col-lg-12">
            <div class="page-login">
                <div id="login">
                    ...
                    <form method="post" action="https://ant-du-lich.mysapo.net/account/register"
                        id="customer_register" accept-charset="UTF-8"><input name="FormType" type="hidden"
                            ...
                            type="hidden" id="Token-22b3be00dbc5450788f2beb6110b1b1f" name="Token" />
                        <script
                            src="../../www.google.com/recaptcha/apif78f.js?render=6Ldtu4IUAAAAAMQzG1gCw3wFlx_GytlZyLrXcsuK"></script>
                        <script>grecaptcha.ready(function () { grecaptcha.execute("6Ldtu4IUAAAAAMQzG1gCw3wFlx_GytlZyLrXcsuK", { action: "customer_register" }).then(function (token) { document.getElementById("Token-22b3be00dbc5450788f2beb6110b1b1f").value = token }); });</script>
