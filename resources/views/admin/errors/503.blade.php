                                ...
                                <div class="card mb-0 border-0 shadow-none mb-0">
                                    <div class="card-body p-sm-5 m-lg-4">
                                        <div class="error-img text-center px-5">
                                            <img src="{{ asset('assets/images/auth/503.png') }}" class="img-fluid"
                                                alt="">
                                        </div>
                                        <div class="mt-4 text-center pt-4">
                                            <div class="position-relative">
                                                <h4 class="fs-2xl error-subtitle text-uppercase mb-0">Service
                                                    Unavailable</h4>
                                                <p class="fs-base text-muted mt-3">The service is temporarily
