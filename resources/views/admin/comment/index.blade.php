                                ...
                                <div class="col-lg-auto">
                                    <div class="hstack flex-wrap gap-2">
                                        <button class="btn btn-subtle-danger d-none" id="remove-actions"
                                            ...
                                            <a href="{{route('comments.create')}}" class="btn btn-success"><i data-feather="plus-square"></i>
                                                Thêm danh mục
                                            </a>
                                        <div>
...
@endif
                                            ...
                                            <td>{{ $item->content }}</td>
                                            <td>{{ $item->parent ? $item->parent->user->name : 'Bình Luận Chính' }}</td>
                                            ...
                                            <td>
                                                <ul class="d-flex gap-2 list-unstyled mb-0">
                                                    ...
                                                    <li>
                                                        <a href="{{route('comments.edit',$item->id)}}"><i class="mdi mdi-pencil text-muted fs-18 rounded-2 border p-1 me-1"></i></a>
                                                    </li>
                                                    <li>
