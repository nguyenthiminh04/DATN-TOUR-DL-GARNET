...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page title -->
            <form class="col-6" action="{{ route('category_tour.update',$categoryTour->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="category_tour" class="form-label">Tên danh mục<span class="text-danger">*</span></label>
                    <input type="text" id="category_tour" name="category_tour" value="{{ old('category_tour', $categoryTour->category_tour) }}" class="form-control" placeholder="Nhập câu trả lời...">
                    @error('category_tour')
