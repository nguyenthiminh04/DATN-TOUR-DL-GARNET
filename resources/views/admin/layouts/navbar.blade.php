    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#comment" data-bs-toggle="collapse"
                        role="button" aria-expanded="false" aria-controls="comment">
                        <i class="ph-gauge"></i> <span data-key="t-dashboards">Bình luận</span>
                    </a>
                    <div class="collapse menu-dropdown" id="comment">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('comment')}}" class="nav-link">Danh sách bình luận
                                </a>
                            </li>
                        </ul>
                    </div>
