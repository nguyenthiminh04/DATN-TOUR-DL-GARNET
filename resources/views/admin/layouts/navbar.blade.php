    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="apps-calendar.html" class="nav-link menu-link"> <i class="ph-calendar"></i> <span
                            data-key="t-calendar">Calendar</span> </a>
                </li>

                <li class="nav-item">
                    <a href="apps-chat.html" class="nav-link menu-link"> <i class="ph-chats"></i> <span
                            data-key="t-chat">Chat</span> </a>
                </li>

                <li class="nav-item">
                    <a href="apps-email.html" class="nav-link menu-link"> <i class="ph-envelope"></i> <span
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="apps-ecommerce-products-grid.html" class="nav-link"
                                    data-key="t-products-grid">Products Grid</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="apps-ecommerce-order-overview.html" class="nav-link"
                                    data-key="t-order-overview">Order Overview</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="apps-ecommerce-seller-overview.html" class="nav-link"
                                    data-key="t-seller-overview">Seller Overview</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a href="apps-file-manager.html" class="nav-link menu-link"> <i class="ph-folder-open"></i>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarLearning">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="#sidebarCourses" class="nav-link" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarCourses" data-key="t-courses">
                                    Courses </a>
                                <div class="collapse menu-dropdown" id="sidebarCourses">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-learning-list.html" class="nav-link"
                                                data-key="t-list-view">List View</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-learning-grid.html" class="nav-link"
                                                data-key="t-grid-view">Grid View</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-learning-category.html" class="nav-link"
                                                data-key="t-category">Category</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-learning-overview.html" class="nav-link"
                                                data-key="t-overview">Overview</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-learning-create.html" class="nav-link"
                                                data-key="t-create-course">Create Course</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a href="#sidebarStudent" class="nav-link" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarStudent" data-key="t-students">
                                    Students </a>
                                <div class="collapse menu-dropdown" id="sidebarStudent">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-student-subscriptions.html" class="nav-link"
                                                data-key="t-my-subscriptions">My Subscriptions</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-student-courses.html" class="nav-link"
                                                data-key="t-my-courses">My Courses</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a href="#sidebarInstructors" class="nav-link" data-bs-toggle="collapse"
                                    ...
                                    data-key="t-instructors"> Instructors </a>
                                <div class="collapse menu-dropdown" id="sidebarInstructors">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-instructors-list.html" class="nav-link"
                                                data-key="t-list-view">List View</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-instructors-grid.html" class="nav-link"
                                                data-key="t-grid-view">Grid View</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-instructors-overview.html" class="nav-link"
                                                data-key="t-overview">Overview</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-instructors-create.html" class="nav-link"
                                                data-key="t-create-instructors">Create Instructor</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarRealeEstate">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="apps-real-estate-map.html" class="nav-link" data-key="t-listing-map">Listing
                                    Map</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="#sidebarAgent" class="nav-link" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarAgent" data-key="t-agent"> Agent
                                </a>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarAgencies" class="nav-link" data-bs-toggle="collapse" role="button"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarPages">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="pages-profile-settings.html" class="nav-link" data-key="t-profile-setting">
                                    Profile Settings </a>
                            </li>
                            <li class="nav-item">
                                <a href="pages-contacts.html" class="nav-link" data-key="t-contacts"> Contacts
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#customUI" data-bs-toggle="collapse"
                        ...
                        <i class="ph-wrench"></i> <span data-key="t-custom-ui">Custom UI</span> <span
                            class="badge badge-pill bg-danger" data-key="t-custom">Custom</span>
                    </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarCharts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="charts-apex-polar.html" class="nav-link" data-key="t-polar-area">Polar
                                    Area</a>
                            </li>
                        </ul>
                    </div>
