        ...
        <div class="container-fluid">
            ...
            <form class="col-6" action="{{ route('categorytour.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="category_tour" name="category_tour" value="{{ old('category_tour') }}" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="responsibility" name="responsibility" value="{{ old('responsibility') }}" rows="2"
                        placeholder="Nhập mô tả danh mục tour..."></textarea>
