...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            <!-- start page category_tour -->
            <div class="row">
                <div class="col-12">
                    <div class="page-category_tour-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Danh Sách danh mục tour</h4>

                        <div class="page-category_tour-right">
            ...
            <!-- end page category_tour -->
            <form class="col-6" action="{{ route('categorytour.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="category_tour" class="form-label">Tên danh mục tour<span class="text-danger">*</span></label>
                    <input type="text" id="category_tour" name="category_tour" value="{{ $categorytour->category_tour }}" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description"  rows="2"
                        placeholder="Nhập mô tả danh mục tour..."> {{ $categorytour->description }}</textarea>
                    @error('description')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="slug" name="slug" rows="2"
                        placeholder="Nhập đường dẫn danh mục tour...">{{ $categorytour->slug }}</textarea>
                    @error('slug')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="responsibility" name="responsibility" {{ $categorytour->responsibility }} rows="2"
                        placeholder="Nhập  danh mục tour..." > {{ $categorytour->responsibility }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="status1" name="status">
                            ...
                            <option value="1" {{ $categorytour->status == '1' ? 'selected' : '' }}>Hiển Thị</option>
                            <option value="0" {{ $categorytour->status == '0' ? 'selected' : '' }}>Ẩn</option>
                        </select>
                    </div>
                </div><!--end row-->
                <div class="mb-3">
                    <a href="{{ route('categorytour.index') }}" class="btn btn-info">Trở về</a>
