            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Quản Lý Danh Mục Tour</h4>
                        ...
                        <div class="card-body">
                            <form action="{{ route('categorytour.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="responsibility" name="responsibility" {{ $categorytour->responsibility }}
                                        rows="2" placeholder="Nhập  danh mục tour..."> {{ $categorytour->responsibility }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status1" name="status">
                                        ...
                                        <option value="1" {{ $categorytour->status == '1' ? 'selected' : '' }}>Hiển
                                            Thị</option>
                                        <option value="0" {{ $categorytour->status == '0' ? 'selected' : '' }}>Ẩn
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3 text-end">
                                    ...
                                    <a href="{{ route('categorytour.index') }}" class="btn btn-danger">Hủy</a>
                                </div>
                            </form>
                        </div>
                    </div>
