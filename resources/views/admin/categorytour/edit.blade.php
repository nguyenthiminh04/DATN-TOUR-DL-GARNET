...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- end page title -->
            <form class="col-6" action="{{ route('categorytour.update',$categoryTour->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="categorytour" class="form-label">Tên danh mục<span class="text-danger">*</span></label>
                    <input type="text" id="categorytour" name="categorytour" value="{{ old('categorytour', $categoryTour->categorytour) }}" class="form-control" placeholder="Nhập câu trả lời...">
                    @error('categorytour')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="description" name="description" value="{{ old('description', $categoryTour->description) }}" class="form-control" placeholder="Nhập câu trả lời...">
                    @error('description')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="price" id="price" class="form-control" value="{{ old('price', $categoryTour->price) }}">
                    @error('price')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
