...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form class="col-6" action="{{ route('tour.update',$tour->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" id="name" name="name" value="{{  $tour->name }}" class="form-control" placeholder="Nhập tên tour...">
                @error('name')
        ...
        <div class="mb-3">
          ...
          <input type="text" id="schedule" name="schedule" value="{{  $tour->schedule }}" class="form-control" placeholder="Nhập lịch trình tour...">
          @error('schedule')
              <span class="text-danger">{{ $message }}</span>
          @enderror
      </div>
              <div class="mb-3">
                  ...
                  <input type="text" id="move_method" name="move_method" value="{{  $tour->move_method }}" class="form-control"
          ...
          @enderror
              ...
              <div class="mb-3">
                  <label for="starting_gate" class="form-label">Điểm khởi hành<span
                          class="text-danger">*</span></label>
                  <input type="text" id="starting_gate" name="starting_gate" value="{{  $tour->starting_gate }}" class="form-control"
                  ...
                  <div class="col-lg-6">
                      <div class="mb-3">
                          <label for="start_date" class="form-label">Ngày Bắt Đầu<span
                                  class="text-danger">*</span></label>
                          <input type="datetime-local" id="start_date" name="start_date" value="{{  $tour->start_date }}" class="form-control"
                  ...
                  <div class="col-lg-6">
                      <div class="mb-3">
                          <label for="end_date" class="form-label">Ngày Kết Thúc<span
                                  class="text-danger">*</span></label>
                          <input type="datetime-local" id="end_date" name="end_date" value="{{  $tour->end_date }}" class="form-control"
                              placeholder="Lessons" >
                              @error('end_date')
              <span class="text-danger">{{ $message }}</span>
          @enderror
                  ...
                  <div class="col-lg-6">
                      <div class="mb-3">
                          <label for="price_old" class="form-label">Giá cũ<span
                                  class="text-danger">*</span></label>
                          <input type="number" id="price_old" name="price_old" value="{{  $tour->price_old }}" class="form-control"
                  ...
                  <div class="col-lg-6">
                      <div class="mb-3">
                          <label for="price_children" class="form-label">Giá trẻ em<span
                                  class="text-danger">*</span></label>
                          <input type="number" id="price_children" name="price_children" value="{{  $tour->price_children }}" class="form-control"
                  ...
                  <div class="col-lg-6">
                      <div class="mb-3">
                          <label for="sale" class="form-label">Giảm Giá<span
                                  class="text-danger">*</span></label>
                          <input type="number" id="sale" name="sale" value="{{  $tour->sale }}" class="form-control"
                  ...
                  <div class="col-lg-6">
                      <div class="mb-3">
                          <label for="number_guests" class="form-label">Số lượng khách tối đa<span
                                  class="text-danger">*</span></label>
                          <input type="number" id="number_guests" name="number_guests" value="{{  $tour->number_guests }}" class="form-control"
                        ...
                        <tbody id="image-table-body">
                            ...
                            <tr>
                                <td class="d-flex align-item-center">
                                    <img id="preview_{{$index}}" src="{{ Storage::url($hinhAnh->image) }}" alt="Hình Ảnh SẢn Phẩm"
                                    style="width: 50px" class="me-3">
                                    <input type="file" id="image" name="list_hinh_anh[{{$hinhAnh->id}}]" class="form-control"
