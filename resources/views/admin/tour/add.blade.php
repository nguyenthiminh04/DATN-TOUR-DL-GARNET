        ...
        <div class="container-fluid">
            ...
            <form class="col-6" action="{{ route('tour.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="journeys" name="journeys" value="{{ old('journeys') }}" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="schedule" name="schedule" value="{{ old('schedule') }}" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="starting_gate" name="starting_gate" value="{{ old('starting_gate') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="number" id="price_old" name="price_old" value="{{ old('price_old') }}"
                        ...
                        <select name="location_id" class="form-select w-100" id="status1">
                            ...
                            @foreach ($listlocation as $status)
                                <option value="{{ $status->id }}"
                                    {{ old('location_id') == $status->id ? 'selected' : '' }}>{{ $status->name }}</option>
                            @endforeach
                        </select>
                        @error('location_id')
                            <span class="text-danger">{{ $message }}</span>
                            ...
                            <tbody id="image-table-body">
                                <tr>
                                    <td class="d-flex align-item-center">
                                        ...
                                        <input type="file" id="image" name="list_hinh_anh[id_0]"
