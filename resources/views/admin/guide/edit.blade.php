        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Sửa thông tin</h4>
            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('guide.update', $edit->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method("PUT")
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" name="name" 
                                       value="{{$edit->name}}" class="form-control" placeholder="Nhập tên">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    <label for="address" class="form-label">Địa Chỉ<span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="address" name="address" value="{{$edit->address}}"
                                ...
                                <div class="mb-3">
                                    <label for="phone_number" class="form-label">Số điện thoại<span
                                            class="text-danger">*</span></label>
                                    <input type="number" id="phone_number" name="phone_number" value="{{$edit->phone_number}}"
                                ...
                                <div class="mb-3">
                                    <label for="skills" class="form-label">Kỹ năng<span
                                            class="text-danger">*</span></label>
                                    <input type="skills" id="skills" name="skills" value="{{$edit->skills}}"
                                ...
                                <div class="mb-3">
                                    <label for="status1" class="form-label">Trạng Thái<span
                                            ...
                                            <select class="form-select" id="status1" name="status">
                                                ...
                                                <option value="active" {{ $edit->status == 'active' ? 'selected' : '' }}>Hoạt động
                                                </option>
                                                <option value="inactive" {{ $edit->status == 'inactive' ? 'selected' : '' }}>Dừng</option>
                                            </select>
                                </div>
